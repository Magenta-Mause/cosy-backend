...
public class JwtUtilsTests {
    ...
    void generateIdentityToken_shouldReturnValidToken() {
        ...
        Map<String, Object> parsedClaims = jwtUtils.getTokenContentBody(token, JwtTokenBody.TokenType.IDENTITY_TOKEN);
    ...
    void generateRefreshToken_shouldReturnValidToken() {
        ...
        Map<String, Object> parsedClaims = jwtUtils.getTokenContentBody(token, JwtTokenBody.TokenType.REFRESH_TOKEN);
        assertEquals(username, parsedClaims.get("username"));
